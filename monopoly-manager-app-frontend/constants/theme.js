...
export const FONTS = {
  ...
  h3: { fontWeight: "600", fontSize: SIZES.h3, lineHeight: 24 }, // '600' is semi-bold
  h4: { fontWeight: "600", fontSize: SIZES.h4, lineHeight: 22 },
  body: {
    fontWeight: "normal",
  ...
  button: { fontWeight: "600", fontSize: SIZES.h4, color: COLORS.background },
};
